...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2019 a las 22:53:40
...
--
ALTER TABLE `alumno`
  ADD CONSTRAINT `alumno_ibfk_1` FOREIGN KEY (`id_alumno`) REFERENCES `facultad` (`id_facultad`);

--
-- Filtros para la tabla `copas`
--
ALTER TABLE `copas`
  ADD CONSTRAINT `fk_copas_facultad` FOREIGN KEY (`ganador`) REFERENCES `facultad` (`id_facultad`);
COMMIT;
